...
add wave -noupdate -group DCACHE /system_tb/DUT/CPU/CM/DCACHE/reqAddr
...
add wave -noupdate -expand -group PC /system_tb/DUT/CPU/DP/pcif/branch_pc4
...
WaveRestoreCursors {{Cursor 1} {87838770 ps} 0}
